...
例:
    ...
    python face-mosaic-yolov8.py "rtsp://camera/stream" --output udp://127.0.0.1:9000
    python face-mosaic-yolov8.py "rtsp://camera/stream" --model yolov8s.pt --confidence 0.6
"""
